create table if not exists public.seed_evidence_entries (
...
create index if not exists seed_evidence_entries_claim_id_created_at_idx
...
grant select
  on table public.seed_evidence_entries
...
drop policy if exists "public read seed evidence entries"
  on public.seed_evidence_entries;
drop policy if exists "authenticated insert seed evidence entries"
  on public.seed_evidence_entries;
